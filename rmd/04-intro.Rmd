...
finished by embryonic day 5. (E5) [@reik2001; @smallwood2012]. The
...
```{r if3, echo=FALSE, fig.align='center', fig.cap="(ref:ifc3)", fig.scap="Graphical summary of the biology of germline stem cell specification and transitions", fig.width=4.5, fig.height=6}
...
[@zhu2016a]. Many properties of DNAmemake it an appealing mechanistic
...
modification could also be a key initiator of EI [@siklenka2015]. H3K9
...
inheritance [@alshanbayeva2021], Chapter 2.
...
2.  Development of data analysis pipelines. Please see the Methods, for
