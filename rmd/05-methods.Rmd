...
on a genome index built using bismark_genome_preparation. Methylation
information for individual cytosines (methylation calls) is extracted
using the bismark_methylation_extractor tool from the Bismark package.
...
#### CNV analysis {#m3.5.3 .unnumbered}
