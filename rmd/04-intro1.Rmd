...
throughout history, reviewed in [@pisco2016], it can be broadly
...
## Epigenetic vectors and mechanisms {.unnumbered}
...
sperm chromatins during spermiogenesis [@ren2017]. ncRNAs are found to
...
[@li2012] and 2) small-ncRNA, less than 200 nucleotides (sncRNA)
[@bouckenheimer2018]. Small regulatory RNAs (siRNAs, miRNAs, tRNAs, and
...
[@sullivan2016]. Aside from epididymosomes, RNAs have been found in
...
behavioural and metabolic features in other mice [@gapp2014]. These
...
[@vansteenwyk2020; @andersson2014; @gapp2020; @conine2021].
...
(ref:ifc2) \textbf{A diagram depicting the biology of germline stem cell differentiation and transitions.}
...
modification of epigenetic markers such as DNAme [@reik2001] and histone
modifications [@xu2018]. During the evolution of multicellular
organisms, many cells and tissues acquire distinct gene expression
patterns [@morgan2005]. In normal developmental or pathological
...
installation of a new set of marks [@morgan2005]. Genome-wide epigenetic
reprogramming happens when the developmental potential of cells changes
[@morgan2005]. During reprogramming, histone modifications are
reorganized and passive DNA demethylation occurs [@morgan2005]. This is
...
expression [@surani2007]. In addition to DNA demethylation, the
reprogramming process in PGCs is linked to the loss of a variety of
histone modifications [@hajkova2008]. The disappearance of restrictive
...
[@hajkova2011]. After a sperm fertilizes an ovum, nearly all epigenetic
...
have taken place in the germ cells [@reik2001]. During embryo
development, there are two waves of epigenetic reprogramming, reviewed
in [@smallwood2012]. After fertilization in the preimplantation embryo
...
which is finished by E5 [@reik2001; @smallwood2012]. The father's genome
is demethylated swiftly and aggressively, whereas the mother's genome is
slowly demethylated [@reik2001]. On day E5, embryonic DNA begins to be
...
epigenetic markers [@reik2001]. The PGCs, which are progenitors of both
male and female germ cells in the developing embryo, contain the
parental genome's methylation signatures [@reik2001]. PGCs are epiblast
...
[@morgan2005]. PGCs undergo rapid demethylation beginning around E7--8,
...
methylation [@morgan2005]. In PGCs, histone marks are also significantly
remodelled [@seki2005]. When epigenetic reprogramming in PGCs is
...
H3K27me3 [@hajkova2011]. Reprogramming is complete in the male germline
...
to insufficient germline erasure [@hajkova2011]. Finally, demethylation
...
accessibility, and 3D chromatin architecture, revied in [@xu2018].
...
reviewed in [@conine2021]. Although epigenetic modifications can occur
...
[@wang2017]. The extent of epigenetic reprogramming, however, is
...
modifications with a low chance of being passed down [@sharma2015;
@wei2014a].
...
how ubiquitous this phenomenon is [@kazachenka2018].
...
translational phenotypes [@camacho2018]. Furthermore, rearing
...
separation period [@franklin2010]. This figure is adapted from
[@vansteenwyk2018].
...
(only control samples), [Chapter 1](#chapter1), and to investigate how
...
or dietary change [@rodgers2015; @fullston2013; @gapp2014; @chen2013;
@sharma2016]. Microinjection experiments using the MSUS mouse model, in
...
metabolic traits in other mice [@gapp2014]. Nevertheless, given the
