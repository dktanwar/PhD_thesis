...
(ref:inc1) \textbf{A brief background of the term "epigenetics".} The
timeline is representedon the X-axis, while the normalized proportion of
articles containing the generickeywords 'cell' and 'function' is
represented on the y-axis. The red curve shows theamount of "Medline"
entries per year that contain the wildcarded search word 'epigen\*'.
This figure is taken from [@pisco2016].

```{r if1, echo=FALSE, fig.align='center', fig.cap="(ref:inc1)", fig.scap="A brief background of the term 'epigenetics'", fig.width=6.42, fig.height=4.45}
...
(ref:ifc2) \textbf{A diagram depicting the biology of germline stem celldifferentiation and transitions.}
This figure is adapted from [@hammoud2015]


```{r if2, echo=FALSE, fig.align='center', fig.cap="(ref:ifc2)", fig.scap="A diagram depicting the biology of germline stem celldifferentiation and transitions", fig.width=6.42, fig.height=4.45}
...
epigenetic reprogramming, Figure \ref{fig:if3}. After fertilization in
...
(ref:ifc3) \textbf{Changes in DNA methylation during developmental
epigenetic reprogramming.} The developmental timeline is represented on
the x-axis, while DNA methylation level is represented on the y-axis.
The methylation in the male embryo is represented by the blue line,
whereas the methylation in the female embryo is represented by the red
line. This figure is taken from [@smallwood2012].

```{r if3, echo=FALSE, fig.align='center', fig.cap="(ref:ifc3)", fig.scap="Changes in DNA methylation during developmental epigenetic reprogramming", fig.width=6.42, fig.height=4.45}
img <- readPNG("figure/intro/3.png")
grid.raster(img)
```
...
[@franklin2010]. It is an ideal model to study the possible
transgenerational effects of life experiences on the genome and the
epigenome.

(ref:ifc4) \textbf{Illustration of the unpredictable maternal
...
separation period (van Steenwyk, Roszkowski, Manuella, Franklin, &
Mansuy, 2018). This figure is adapted from [@vansteenwyk2018].
