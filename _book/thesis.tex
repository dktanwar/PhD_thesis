...
\end{verbatim}
\begin{verbatim}
Installing package into '/Users/tanwar/Documents/PhD_thesis/renv/library/R-4.1/x86_64-apple-darwin17.0'
(as 'lib' is unspecified)
\end{verbatim}
\begin{verbatim}
Warning in download.file(url, destfile, method, mode =
"wb", ...): cannot open URL 'https://cran.rstudio.com/src/contrib/
remotes_2.4.0.tgz': HTTP status was '404 Not Found'
\end{verbatim}
\begin{verbatim}
Warning in download.packages(pkgs, destdir = tmpd, available =
available, : download of package 'remotes' failed
\end{verbatim}
\begin{Shaded}
\begin{Highlighting}[]
